...
<head>
	<link href="css/css-root/style.css" rel="stylesheet">
	...
	<scrip src='https://cdnjs.cloudflare.com/ajax/libs/prefixfree/1.0.7/prefixfree.min.js'>
		</script>
...
<body>
	...
	<div class="login">
		<div align="center" class="space1">
			<img src="img/vitrine-virtual.png" width="300">
		</div>
		<form method="post" action="autenticar.php">
			...
			<button type="submit" class="btn btn-block ">Logar</button>
			<div align="center" class="space2">
            ...
            <div class="modal-content" >
                ...
                <form method="POST" id="form">
                    ...
                    <div class="modal-footer">
                        <button id="btn-fechar" type="button" class="btn btn-secondary" data-dismiss="modal" href= "/index.php">Fechar</button>
