...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div align="center" class="text-white"><?php echo 'Escola: '. $nome_esc ?></div><hr class="sidebar-divider my-2">
            <div align="center" class="text-white"><?php echo 'Turma: '. $nome_serie ?></div><br>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="../img/alunos/<?php echo $img_usu ?>">
                ...
                <form id="form-perfil" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label >Imagem</label>
                                <input type="file" value="<?php echo @$img_usu ?>"  class="form-control-file" id="imagem" name="imagem" onChange="carregarImg();">
                            </div>

                            <div id="divImgConta">
                                <?php if(@$img_usu != ""){ ?>
                                    <img src="../img/alunos/<?php echo $img_usu ?>"  width="100%" id="target">
                                <?php  }else{ ?>
