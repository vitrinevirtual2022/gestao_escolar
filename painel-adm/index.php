    ...
    $pag = @$_GET["pag"]; //A variével '$pag' recebe o '$_GET[pag]' de pagina, ou seja, a variavel '$pag' que vem via URL
    //O sinal de '@' é utilizado para que não seja mostrado um alerta de variavel indefinida
    //O sinal de '@' pode ser substituido pelo termo 'isset()' que possui a mesma função
    $menu1 = "secretarios";
    $menu2 = "professores";
    $menu3 = "coordenadores";
    $menu4 = "escolas";
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Heading -->
                <div class="sidebar-heading text-white mx-3 mb-2">
                    Painel de Cadastros
                </div>
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu2 ?>">Professores</a>
                             ...
                             <a class="collapse-item" href="index.php?pag=<?php echo $menu3 ?>">Coordenadores</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu4 ?>">Escolas</a>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo2" aria-expanded="true" aria-controls="collapseTwo2">
                        ...
                        <span>Ano Escolar/ Disciplinas</span>
                    </a>
                    <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            
                            
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu5 ?>">Ano Escolar</a>
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu6 ?>">Disciplinas</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu7 ?>">Exibir Turmas Criadas</a>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu8 ?>">Documentos e Relatórios</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <img class="mt-2 mb-1" src="../img/vitrine-virtual.png" width="150" height="60">
