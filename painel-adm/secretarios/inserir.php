...
$caminho = '../../img/secretarios/' .$nome_img;
...
if($id == ""){
	$res = $pdo->prepare("INSERT INTO secretarios SET nome = :nome, nome_escola = :nome_escola, cpf = :cpf, email = :email, endereco = :endereco, telefone = :telefone, foto = '$imagem'");	
	...
	$res = $pdo->prepare("UPDATE secretarios SET nome = :nome, nome_escola = :nome_escola, cpf = :cpf, email = :email, endereco = :endereco, telefone = :telefone, foto = '$imagem' WHERE id = '$id'");
